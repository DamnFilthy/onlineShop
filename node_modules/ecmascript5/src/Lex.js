...
(function(){"use strict";
	function Lex () {return this.initLex();}
	var Lex_ = Lex._ = function Lex_ () {return this;},
	    lex = Lex_.prototype = Lex.prototype;
	Lex.check = function (obj) {
		return obj && obj.initLex === lex.initLex;
	};
	Lex.create = function (obj, args) {
		obj = obj || new Lex_();
		obj.initLex = lex.initLex || function () {
			return this.empty();
		};
		obj.empty = function () {
			this.tokens = [];
		...
		if (args) obj.initLex.apply(obj, args);
		return obj;
	};
	(module.exports = Lex).create(lex);
}).call(this);